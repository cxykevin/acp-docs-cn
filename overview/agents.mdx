---
title: "代理"
description: "实现 Agent Client Protocol 的代理"
---
...
- [Claude Code](https://docs.anthropic.com/en/docs/claude-code/overview) (通过 [Zed 的 SDK 适配器](https://github.com/zed-industries/claude-code-acp))
- [Codex CLI](https://developers.openai.com/codex/cli) (通过 [Zed 的适配器](https://github.com/zed-industries/codex-acp))
...
- [JetBrains Junie _(即将推出)_](https://www.jetbrains.com/junie/)
